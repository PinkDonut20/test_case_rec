...
- Исправлена сериализация OCR в JSON (конвертация `numpy` типов в обычные Python типы).
- Улучшена эвристика ФИО: исключаются заголовки документа вроде `ВОДИТЕЛЬСКОЕ УДОСТОВЕРЕНИЕ`.
